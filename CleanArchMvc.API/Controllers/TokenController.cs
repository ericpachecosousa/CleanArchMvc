...
namespace CleanArchMvc.API.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public TokenController(IAuthenticate authenticate, IConfiguration configurantion)
        {
        ...
        private UserToken GenerateToken(LoginModel userInfo)
        {
            ...
            var privateKey = new SymmetricSecurityKey(
                Encoding.UTF8.GetBytes(_configurantion["Jwt:SecretKey"]));
            ...
            JwtSecurityToken token = new JwtSecurityToken(
                //emissor
                issuer: _configurantion["Jwt:Issuer"],
                //audiencia
                audience: _configurantion["Jwt:Audience"],
                //claims
                claims: claims,
                //data de expiracao
                expires: expiration,
